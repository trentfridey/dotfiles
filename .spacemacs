...
before packages are loaded."
  (setq default-frame-alist (append (list '(internal-border-width . 24)))) ;; nice margin on frame
...
(custom-set-variables
 ...
 '(helm-buffers-left-margin-width 12)
